...
void board_init_f(ulong dummy)
{
	...
	*((volatile unsigned int *)(0xb2200fe0)) = (ccu_value | 0x00000078);
    ...
    /* close ccu l1cache prefetcher trust feature*/
	ccu_mscr = *((volatile unsigned int *)(0xb2200060));
	*((volatile unsigned int *)(0xb2200060)) = (ccu_mscr | 0x00000010);
