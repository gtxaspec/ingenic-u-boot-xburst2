...
{
#ifdef CONFIG_T41N                     //  ODT_D ODT_U CMD_D CMD_U CLK_D CLK_U DQX_D DQX_U VREF  K_RTT KGD_DS RTT&DIC
    unsigned int init_ddr_par[INDEX_EN] = {0x02, 0x02, 0x05, 0x05, 0x05, 0x05, 0x10, 0x10, 0x8b, 0x01, 0x01, 0x06,
                                           0x15, 0x15, 0x0e, 0x0d, 0x0d, 0x0e, 0x03};
                                       // DQS0R  DQS1R DQRX  DQS0T DQS1T DQTX  S_TRX

#elif defined(CONFIG_T41NQ)            //  ODT_D ODT_U CMD_D CMD_U CLK_D CLK_U DQX_D DQX_U VREF  K_RTT KGD_DS RTT&DIC
    unsigned int init_ddr_par[INDEX_EN] = {0x00, 0x00, 0x0f, 0x0f, 0x03, 0x03, 0x14, 0x14, 0x8b, 0x00, 0x01, 0x02,
                                           0x11, 0x11, 0x0a, 0x08, 0x08, 0x0a, 0x03};
                                       //  DQS0R DQS1R DQRX  DQS0T DQS1T DQTX  S_TRX

#elif defined(CONFIG_T41ZX)            //  ODT_D ODT_U CMD_D CMD_U CLK_D CLK_U DQX_D DQX_U VREF  K_RTT KGD_DS RTT&DIC
...
#elif defined(CONFIG_T41XQ)            //  ODT_D ODT_U CMD_D CMD_U CLK_D CLK_U DQX_D DQX_U VREF  K_RTT KGD_DS RTT&DIC
    unsigned int init_ddr_par[INDEX_EN] = {0x00, 0x00, 0x05, 0x05, 0x05, 0x05, 0x0f, 0x0f, 0x8b, 0x01, 0x01, 0x06,
                                           0x12, 0x12, 0x0b, 0x08, 0x08, 0x0b, 0x03};
                                       //  DQS0R DQS1R DQRX  DQS0T DQS1T DQTX  S_TRX

#elif defined(CONFIG_T41L) || defined(CONFIG_T41ZL)
                                       //  ODT_D ODT_U CMD_D CMD_U CLK_D CLK_U DQX_D DQX_U VREF  K_RTT KGD_DS RTT&DIC
    unsigned int init_ddr_par[INDEX_EN] = {0x00, 0x00, 0x05, 0x05, 0x05, 0x05, 0x0f, 0x0f, 0x80, 0x02, 0x00, 0x04,
                                           0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
                                       //  DQS0R DQS1R DQRX  DQS0T DQS1T DQTX  S_TRX

#elif defined(CONFIG_T41LQ)            //  ODT_D ODT_U CMD_D CMD_U CLK_D CLK_U DQX_D DQX_U VREF  K_RTT KGD_DS RTT&DIC
    unsigned int init_ddr_par[INDEX_EN] = {0x00, 0x00, 0x05, 0x05, 0x05, 0x05, 0x0f, 0x0f, 0x8b, 0x02, 0x00, 0x04,
                                           0x15, 0x15, 0x0c, 0x07, 0x07, 0x0b, 0x03};
                                       //  DQS0R DQS1R DQRX  DQS0T DQS1T DQTX  S_TRX

#elif defined(CONFIG_T41ZN)            //  ODT_D ODT_U CMD_D CMD_U CLK_D CLK_U DQX_D DQX_U VREF  K_RTT KGD_DS RTT&DIC
...
#elif defined(CONFIG_T41A)             //  ODT_D ODT_U CMD_D CMD_U CLK_D CLK_U DQX_D DQX_U VREF  K_RTT KGD_DS RTT&DIC
    unsigned int init_ddr_par[INDEX_EN] = {0x03, 0x03, 0x08, 0x08, 0x08, 0x08, 0x10, 0x10, 0x8b, 0x01, 0x01, 0x06,
                                           0x2c, 0x2c, 0x1d, 0x12, 0x12, 0x14, 0x03};
                                       //  DQS0R DQS1R DQRX  DQS0T DQS1T DQTX  S_TRX

#elif defined(CONFIG_T41ZM)            //  ODT_D ODT_U CMD_D CMD_U CLK_D CLK_U DQX_D DQX_U VREF  K_RTT KGD_DS RTT&DIC
    unsigned int init_ddr_par[INDEX_EN] = {0x05, 0x05, 0x0f, 0x0f, 0x0f, 0x0f, 0x14, 0x14, 0x8b, 0x00, 0x00, 0x00,
                                           0x11, 0x11, 0x0a, 0x06, 0x06, 0x09, 0x03};
                                       //  DQS0R DQS1R DQRX  DQS0T DQS1T DQTX  S_TRX

#elif defined(CONFIG_T41ZMC)           //  ODT_D ODT_U CMD_D CMD_U CLK_D CLK_U DQX_D DQX_U VREF  K_RTT KGD_DS RTT&DIC
    unsigned int init_ddr_par[INDEX_EN] = {0x00, 0x00, 0x0e, 0x0e, 0x03, 0x03, 0x0f, 0x0f, 0x8b, 0x00, 0x01, 0x02,
                                           0x0c, 0x0c, 0x07, 0x07, 0x07, 0x07, 0x01};
                                       //  DQS0R DQS1R DQRX  DQS0T DQS1T DQTX  S_TRX

#elif defined(CONFIG_T41ZG)            //  ODT_D ODT_U CMD_D CMD_U CLK_D CLK_U DQX_D DQX_U VREF  K_RTT KGD_DS RTT&DIC
    unsigned int init_ddr_par[INDEX_EN] = {0x01, 0x01, 0x05, 0x05, 0x05, 0x05, 0x0f, 0x0f, 0x96, 0x00, 0x00, 0x00,
                                           0x19, 0x19, 0x0e, 0x0c, 0x0c, 0x0f, 0x03};
                                       //  DQS0R DQS1R DQRX  DQS0T DQS1T DQTX  S_TRX

#elif defined(CONFIG_T41ZGC)           //  ODT_D ODT_U CMD_D CMD_U CLK_D CLK_U DQX_D DQX_U VREF  K_RTT KGD_DS RTT&DIC
    unsigned int init_ddr_par[INDEX_EN] = {0x00, 0x00, 0x05, 0x05, 0x05, 0x05, 0x14, 0x14, 0x80, 0x00, 0x01, 0x02,
                                           0x0f, 0x0f, 0x07, 0x07, 0x07, 0x07, 0x00};
                                       //  DQS0R DQS1R DQRX  DQS0T DQS1T DQTX  S_TRX

#else                                  //  ODT_D ODT_U CMD_D CMD_U CLK_D CLK_U DQX_D DQX_U VREF  K_RTT KGD_DS RTT&DIC
    unsigned int init_ddr_par[INDEX_EN] = {0x00, 0x01, 0x0e, 0x0e, 0x0e, 0x0e, 0x14, 0x14, 0x8b, 0x01, 0x01, 0x06,
                                           0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}; /* old version */
                                       //  DQS0R DQS1R DQRX  DQS0T DQS1T DQTX  S_TRX

#endif

#if 0
#ifdef CONFIG_DDR_TYPE_DDR3 // D.I.C: 1 5        RTT:2 6 9
    init_ddr_par[KGD_RTT_DIC]  = DDR_MR1_VALUE & 0x266;
    init_ddr_par[KGD_ODT] = (init_ddr_par[KGD_RTT_DIC] & 0x4) >> 2 | (init_ddr_par[KGD_RTT_DIC] & 0x40) >> 5 | (init_ddr_par[KGD_RTT_DIC] & 0x200) >> 7;
    init_ddr_par[KGD_DS]  = (init_ddr_par[KGD_RTT_DIC] & 0x2) >> 1 | (init_ddr_par[KGD_RTT_DIC] & 0x20) >> 4;

#elif defined(CONFIG_DDR_TYPE_DDR2) // D.I.C: 1      RTT: 2 6
    init_ddr_par[KGD_RTT_DIC]  = DDR_MR1_VALUE & 0x46;
    init_ddr_par[KGD_ODT] = (init_ddr_par[KGD_RTT_DIC] & 0x4) >> 2 | (init_ddr_par[KGD_RTT_DIC] & 0x40) >> 5;
    init_ddr_par[KGD_DS]  = (init_ddr_par[KGD_RTT_DIC] & 0x2) >> 1;
#endif
#endif
...
void get_ddr_par(unsigned int *ddr_drv_config, int par_size)
{
    ...
    hamming_data0 = *((volatile unsigned int *)(0xb3540240)) & 0xffffff00;;
    hamming_data1 = *((volatile unsigned int *)(0xb3540244)) & 0xffff;
