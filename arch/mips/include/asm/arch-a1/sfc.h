...
//For SFC_GLB
#define GLB_POLL_TIME_OFFSET	(16) //A1 add
#define GLB_POLL_TIME_MSK       (0xffff << GLB_POLL_TIME_OFFSET) //A1 add
#define GLB_DES_EN				(1 << 15) //A1 add
#define GLB_CDT_EN				(1 << 14) //A1 add
...
#define GLB_OP_OFF				(6) //A1 add
#define SLAVE_MODE				(0x0) //A1 add
#define DMA_MODE				(0x1) //A1 add
...
//For SFC_DEV_CONF
#define DEV_CONF_STA_ENDIAN			(31) //A1 add
#define STA_ENDIAN_LSB				(0 << DEV_CONF_STA_ENDIAN) //A1 add
#define STA_ENDIAN_MSB				(1 << DEV_CONF_STA_ENDIAN) //A1 add
#define	DEV_CONF_SMP_DELAY_OFFSET	(16)
#define	DEV_CONF_SMP_DELAY_MSK		(0x1f << DEV_CONF_SMP_DELAY_OFFSET) //A1 0x3->0x1f
#define DEV_CONF_SMP_DELAY_0		(0)
#define DEV_CONF_SMP_DELAY_45		(1) //A1 add
#define DEV_CONF_SMP_DELAY_90		(2) //A1 add
#define DEV_CONF_SMP_DELAY_135		(3) //A1 add
#define DEV_CONF_SMP_DELAY_180		(4) //A1 add
#define DEV_CONF_SMP_DELAY_225		(5) //A1 add
#define DEV_CONF_SMP_DELAY_270		(6) //A1 add
#define DEV_CONF_SMP_DELAY_315		(7) //A1 add
#define DEV_CONF_SMP_DELAY_1		(8) //A1 add
#define DEV_CONF_SMP_DELAY_2		(16) //A1 add
...
//For SFC_TRAN_CONF0
#define	TRAN_CONF0_CLK_OFFSET			(29) //A1 MODE->CLK
#define	TRAN_CONF0_CLK_MSK				(0x7 << TRAN_CONF0_CLK_OFFSET) //A1 MODE->CLK
#define TRAN_CONF0_CLK_MODE_SSS     	(0) //A1 add
#define TRAN_CONF0_CLK_MODE_SSD     	(1) //A1 add
#define TRAN_CONF0_CLK_MODE_SDS     	(2) //A1 add
#define TRAN_CONF0_CLK_MODE_SDD     	(3) //A1 add
#define TRAN_CONF0_CLK_MODE_DSS     	(4) //A1 add
#define TRAN_CONF0_CLK_MODE_DSD     	(5) //A1 add
#define TRAN_CONF0_CLK_MODE_DDS     	(6) //A1 add
#define TRAN_CONF0_CLK_MODE_DDD     	(7) //A1 add
...
/* For SFC_TRAN_CONF1 */
#define TRAN_CONF1_DATA_ENDIAN			(1 << 18) //A1 add
#define TRAN_CONF1_DATA_ENDIAN_OFFSET	(18) //A1 add
#define TRAN_CONF1_DATA_ENDIAN_LSB		(0) //A1 add
#define TRAN_CONF1_DATA_ENDIAN_MSB		(1) //A1 add
#define TRAN_CONF1_WORD_UNIT_OFFSET		(16) //A1 add
#define TRAN_CONF1_WORD_UNIT_MSK		(3 << 16) //A1 add
#define TRAN_CONF1_TRAN_MODE_OFFSET		(4) //A1 CONFIG0->CONFIG1
#define TRAN_CONF1_TRAN_MODE_MSK		(0xf << TRAN_CONF1_TRAN_MODE_OFFSET) //A1 CONFIG0->CONFIG1
...
#define TRAN_CONF1_SPI_OCTAL			(0x9) //A1 add
#define TRAN_CONF1_SPI_IO_OCTAL			(0xa) //A1 add
#define TRAN_CONF1_SPI_FULL_OCTAL		(0xb) //A1 add
...
//For SFC_INTC
#define	MASK_END		(1 << 4) //A1 add
#define MASK_TREQ		(1 << 3) //A1 add
#define MASK_RREQ		(1 << 2) //A1 add
#define MASK_OVER		(1 << 1) //A1 add
#define MASK_UNDR		(1 << 0) //A1 add

//SFC_CMD_IDX
#define CMD_IDX_MSK                     (0x3f) //A1 add
#define LUT_DATAEN_MSK                  (0x1 << 31) //A1 add
#define LUT_DATAEN_OFF                  (31) //A1 add
#define LUT_DIR_MSK                     (0x1 << 30) //A1 add
#define LUT_DIR_OFF                     (30) //A1 add

/* For SFC_GLB */
#define GLB1_DQS_EN				(1 << 2) //A1 add
#define GLB1_CHIP_SEL_OFFSET	(0) //A1 add
#define GLB1_CHIP_SEL_MSK		(0x3) //A1 add
#define GLB1_CHIP_SEL_0			(0) //A1 add
#define GLB1_CHIP_SEL_1			(1) //A1 add
#define GLB1_CHIP_SEL_01		(2) //A1 add
