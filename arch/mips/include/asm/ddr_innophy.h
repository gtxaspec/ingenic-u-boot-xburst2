...
#if 0
#define DDRP_INNOPHY_CALIB_DELAY_AL_RESULT	(DDR_PHY_OFFSET + 0x1c0)//0x74
#define DDRP_INNOPHY_CALIB_DELAY_AH_RESULT	(DDR_PHY_OFFSET + 0x1c4)//0x75
#define DDRP_INNOPHY_CALIB_DELAY_BL_RESULT	(DDR_PHY_OFFSET + 0x200)//0xA4
#define DDRP_INNOPHY_CALIB_DELAY_BH_RESULT	(DDR_PHY_OFFSET + 0x204)//0xA5
