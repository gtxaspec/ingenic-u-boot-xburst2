...
LIBS-$(CONFIG_UBOOT_LOGO) += drivers/imp/vo/libvo.o
LIBS-$(CONFIG_UBOOT_LOGO) += drivers/imp/dec/libdec.o
ifeq ($(CPU),mpc83xx)
...
#  CONFIG_GPT_CREATOR END

else

ifeq ($(CONFIG_SPL_LZMA),y)
ALL-y += $(obj)u-boot-lzma-with-spl.bin
else
ALL-y += $(obj)u-boot-with-spl.bin
endif
...
$(obj)u-boot-lzma.img:		$(obj)u-boot.bin
	rm -f u-boot.bin.lzma
	lzma -z -k $(obj)u-boot.bin
	$(obj)tools/mkimage -A mips -O u-boot -T firmware -C lzma -a $(CONFIG_SYS_TEXT_BASE) -e $(CONFIG_SYS_TEXT_BASE) \
		-n "u-boot-lzma.img" -d u-boot.bin.lzma  $@
...
$(obj)u-boot-lzma-with-spl.bin: $(obj)spl/u-boot-spl-with-params.bin $(obj)u-boot-lzma.img
		$(OBJCOPY) ${OBJCFLAGS} --pad-to=$(CONFIG_SPL_PAD_TO) \
			-I binary -O binary $< $(obj)spl/u-boot-spl-pad.bin
		cat $(obj)spl/u-boot-spl-pad.bin $(obj)u-boot-lzma.img > $@
		rm $(obj)spl/u-boot-spl-pad.bin
else
...
$(obj)u-boot-lzma-with-spl.bin: $(obj)spl/u-boot-spl.bin $(obj)u-boot-lzma.img
		$(OBJCOPY) ${OBJCFLAGS} --pad-to=$(CONFIG_SPL_PAD_TO) \
			-I binary -O binary $< $(obj)spl/u-boot-spl-pad.bin
		cat $(obj)spl/u-boot-spl-pad.bin $(obj)u-boot-lzma.img > $@
		rm $(obj)spl/u-boot-spl-pad.bin
