...
void preloader_console_init(void)
{
	...
	puts("\n\n\nU-Boot SPL " PLAIN_VERSION "-" INGENIC_UBOOT_VERSIONS " ("  U_BOOT_DATE " - " \
			U_BOOT_TIME ")\n");
	puts("SDK version V1.2.3-20240308\n\n");
#endif
#ifndef CONFIG_UART_LOAD
    ...
    if(0x1111 == chip) {
        ...
        puts("Board info: T41LC\n");
    } else if(0x9999 == chip) {
        puts("Board info: T41LQ\n");
    } else if(0xAAAA == chip) {
        puts("Board info: T41NQ\n");
    } else if(0xBBBB == chip) {
        puts("Board info: T41ZM\n");
    } else if(0xCCCC == chip) {
        puts("Board info: T41ZG\n");
    } else if(0xDDDD == chip) {
        puts("Board info: T41ZMC\n");
    } else if(0xEEEE == chip) {
        puts("Board info: T41ZGC\n");
    } else {
