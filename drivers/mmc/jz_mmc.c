...
#endif
	jz_mmc_writel(0x0, priv, MSC_CLKRT);
...
#if defined(CONFIG_SOC_OLD_THAN_M200) /* old code before m200 */
	while (jz_mmc_readl(priv, MSC_STAT) & MSC_STAT_IS_RESETTING);
#else /*defined(CONFIG_M200) || defined(CONFIG_T10)*/
