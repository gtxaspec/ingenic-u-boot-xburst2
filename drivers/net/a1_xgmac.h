...
#define A1_XGMAC0_NAME_MDIO                      "mii0"
#define A1_XGMAC1_NAME_MDIO                      "mii1"
#define A1_XGMAC0_NAME_DEV                       A1_XGMAC0_NAME_MDIO
#define A1_XGMAC1_NAME_DEV                       A1_XGMAC1_NAME_MDIO

#define A1_XGMAC0_BASE                           0x130b0000
#define A1_XGMAC1_BASE                           0x130c0000

#define A1_XGMAC_MDIO_ADDR_OFFSET		0x00000200
#define A1_XGMAC_MDIO_DATA_OFFSET		0x00000204
#define MII_XGMAC_SADDR		         	(0x1<<18)
#define MII_XGMAC_CMD_SHIFT	        	16
#define MII_XGMAC_WRITE		        	(1 << MII_XGMAC_CMD_SHIFT)
#define MII_XGMAC_READ		        	(3 << MII_XGMAC_CMD_SHIFT)
#define MII_XGMAC_BUSY		        	(0x1<<22)
#define MII_XGMAC_PA_SHIFT	         	16
#define MII_XGMAC_DA_SHIFT	        	21
#define MII_XGMAC_CRS	         	        (0x1<<31)
#define MII_XGMAC_CR_SHIFT	         	19

#define A1_XGMAC_MDIO_C22P_OFFSET		0x00000220

#define A1_CPM_XGMAC_MAC0PHYC    		(0xb00000c8)
#define A1_CPM_XGMAC_MAC1PHYC 			(0xb00000d8)
#define A1_CPM_XGMAC_MACPHYC_RGMII		(0x1)
#define A1_CPM_XGMAC_MACPHYC_RMII		(0x2)

#define A1_CPM_MACCDR_125MHZ 			(125000000)
#define A1_CPM_MACCDR_25MHZ 			(25000000)
#define A1_CPM_MACCDR_2_5MHZ 			(2500000)
#define A1_CPM_MACCDR_50MHZ		        (50000000)


/* mii0 100M PHY clk configration,25m or 50m */
#ifdef CONFIG_BOARD_CALF_1_2
...
/* mii1 100M PHY clk configration,25m or 50m */
...
#if defined(CONFIG_BOARD_CALF_1_3) || defined(CONFIG_BOARD_CALF_1_2) || defined(CONFIG_BOARD_CALF)
...
#if defined(CONFIG_BOARD_CALF_1_3) || defined(CONFIG_BOARD_CALF)
...
#define A1_GMAC1_PHY_RXD3_PIN	GPIO_PA(20)
#define A1_GMAC1_PHY_RXDV_PIN	GPIO_PA(25)
#endif

#define A1_GMAC_PHY_RESET_ENLEVEL	(0)      //SET LOW LEVEL TO RESET
...
#define virt_uncached(addr) ((addr)|(0x1<<29))
...
/* dwxgmac2.h form linux */
/* Misc */


#define  BIT(n)                        (0x1<<n)
#define  GENMASK(h,l)                  (((unsigned int)(~0x0)-(0x1<<l)+1)&((unsigned int)(~0x0)>>(31-h))) /* only support u32 data */
