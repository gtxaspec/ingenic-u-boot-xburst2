...
static struct jz_nand_base_param ds_param[] = {
...
static struct device_id_struct device_id[] = {
	...
	DEVICE_ID_STRUCT(0x72, "DS35Q2GA", &ds_param[1]),
};

static void DS35Q2GA_single_read(struct sfc_transfer *transfer, struct cmd_info *cmd, struct flash_operation_message *op_info) {
...
int ds_nand_init(void)
{
	...
	ds_nand->id_device_count = sizeof(device_id) / sizeof(device_id[0]);

	ds_nand->ops.nand_read_ops.single_read = DS35Q2GA_single_read;
