...
static struct dwc2_core_regs *regs =(struct dwc2_core_regs *)CONFIG_USB_DWC2_REG_ADDR;
...
int usb_lowlevel_init(int index, /*enum usb_init_type init,*/ void **controller)
{
	...
	root_hub_devnum = 0;
        ...
        extern  int usb_stor_curr_port;

        if(usb_stor_curr_port == 0){
		board_usb_init();
                regs= (struct dwc2_core_regs *)CONFIG_USB_DWC2_REG_ADDR;

        }else if(usb_stor_curr_port == 1){
                board_usb1_init();
                regs= (struct dwc2_core_regs *)CONFIG_USB1_DWC2_REG_ADDR;
        }else{
                board_usb2_init();
                regs= (struct dwc2_core_regs *)CONFIG_USB2_DWC2_REG_ADDR;
        }
