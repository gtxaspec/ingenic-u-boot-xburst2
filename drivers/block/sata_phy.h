#ifndef _INGENIC_AHCI_H_
#define _INGENIC_AHCI_H_

#define CONFIG_DWC_AHSATA_BASE_ADDR 0xb30d0000

#define AHSATA_NUM_PORTS            2    //A1 has 2 port
#define P0PHYCR_ADDR                0xb30d0178

/*CPM Sata Clock Gate And SRBC0*/
#define CPM_SRBC_0 					0xb00000f0
#define CPM_CLKGR1_GATE				0xb0000038

/*these config set for rx squelch and rx offset calibration*/
#define P0_RXSQUL					0xb0080030
#define P0_RXOFFSETA 				0xb0080870
#define P0_RXOFFSETB				0xb0080044
#define P0_RXOFFSETC				0xb0080020
