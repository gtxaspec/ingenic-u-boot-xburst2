...
#define DDR_tRC  DDR__ns(50)  /* ACTIVE to ACTIVE command period to the same bank. ns*/
#define DDR_tWR  DDR__ns(17)  /*FIXME WRITE Recovery Time defined by register MR of DDR2 memory, ns*/
#define DDR_tRRD MAX(DDR__tck(4), DDR__ps(6000)) /* FIXME ACTIVE bank A to ACTIVE bank B command period. DDR3 - tCK*/
 ...
 */
#define DDR_tRFC   DDR__ns(262) 	/* AUTO-REFRESH command period. DDR3 - ns*/
//#define DDR_tMINSR 60   /*FIXME Minimum Self-Refresh / Deep-Power-Down . DDR3 no*/
#define DDR_tXP    MAX(DDR__tck(3), DDR__ps(6000))	/*FIXME DDR3 only: Exit active power down to any valid command, ns*/
#define DDR_tMRD   DDR__tck(5)    /*FIXME unit: tCK. Load-Mode-Register to next valid command period: DDR3 rang 4 to 7 tCK. DDR3 spec no */
...
#define DDR_tCCD   DDR__tck(5)	/* CAS# to CAS# command delay , tCK. 4 or 5 */
#define DDR_tFAW   DDR__ns(37)	/* Four bank activate period, DDR3 - ns */
