 ...
 */
/* DDR3 paramters */
#define DDR_ROW     16  /* ROW : 12 to 18 row address ,1G only 512MB*/
#define DDR_ROW1     16  /* ROW : 12 to 18 row address ,1G only 512MB*/
 ...
 */
#define DDR_tRFC   DDR__ns(350) 	/* AUTO-REFRESH command period. DDR3 - ns*/
