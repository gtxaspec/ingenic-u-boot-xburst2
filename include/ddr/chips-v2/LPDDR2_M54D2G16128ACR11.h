 ...
 * =====================================================================================
 *
 *       Filename:  LPDDR2_M54D2G16128ACR11.h
 *
 *    Description:
 *
 *        Version:  1.0
...
#ifndef __LPDDR2_M54D2G16128ACR11_H__
#define __LPDDR2_M54D2G16128ACR11_H__

static inline void LPDDR2_M54D2G16128ACR11_init(void *data)
{
...
#ifndef CONFIG_LPDDR2_M54D2G16128ACR11_MEM_FREQ
#define CONFIG_LPDDR2_M54D2G16128ACR11_MEM_FREQ CONFIG_SYS_MEM_FREQ
#endif

#define LPDDR2_M54D2G16128ACR11 {                    \
    .name = "M54D2G16128ACR11",                    \
    .id   = DDR_CHIP_ID(VENDOR_WINBOND, TYPE_LPDDR2, MEM_256M),    \
    .type = LPDDR2,                        \
    .freq = CONFIG_LPDDR2_M54D2G16128ACR11_MEM_FREQ,            \
    .size = 256,                        \
    .init = LPDDR2_M54D2G16128ACR11_init,                \
}
