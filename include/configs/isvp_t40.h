...
#define INGENIC_UBOOT_VERSIONS "T40-20240407a"
...
#else
#define BOOTARGS_COMMON "console=ttyS1,115200n8 mem=256M@0x0 mem=256M@0x30000000 rmem=256M@0x40000000 nmem=256M@0x50000000"
#endif
...
#define CONFIG_MMC_RATE_MAX 50000000
#define CONFIG_MMC_RATE_MIN 400000
#define CONFIG_MMC_RATE     25000000
#endif
...
#define CONFIG_SPL_PAD_TO		27648 /* equal to spl max size in T40 */
#elif defined(CONFIG_SPL_MMC_SUPPORT)
#define CONFIG_SPL_MAX_SIZE		28672	/* 28672=28KB*/
#define CONFIG_SPL_PAD_TO		28672	/* equal to spl max size in T40 */
#else
#define CONFIG_SPL_MAX_SIZE		26624	/* 26624=26KB*/
#define CONFIG_SPL_PAD_TO		26624	/* equal to spl max size in T40 */
#endif

#define CONFIG_UBOOT_OFFSET     CONFIG_SPL_MAX_SIZE /* equal to spl max size in T40 */
