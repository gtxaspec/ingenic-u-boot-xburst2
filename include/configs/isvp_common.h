...
#if defined(__CONFIG_ISVP_A1_H__)
#define CONFIG_A1
#define CONFIG_SOC "a1"
#else
...
#define SOC_VAR A1A
#define CONFIG_DDR_256M
#elif defined(CONFIG_A1ALL)
#define SOC_VAR A1ALL
#define CONFIG_DDR_128M
#endif
...
#else
#ifdef CONFIG_SPL_LZMA
#define CONFIG_SPL_MAX_SIZE		30000	/* Increase size for LZMA decompression */
#define CONFIG_SPL_PAD_TO		30000	/* equal to spl max size */
#else
...
#define CONFIG_UBOOT_OFFSET     30000 /* Fixed offset for all SPL variants to maintain compatibility */
