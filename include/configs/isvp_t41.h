...
#define INGENIC_UBOOT_VERSIONS "H20241022a"
...
#if defined(CONFIG_T41N)|| defined(CONFIG_T41ZN)
/* T41N & T41ZN */
...
#define DDR_750M
#endif
#elif defined(CONFIG_T41L) || defined(CONFIG_T41LQ) || defined(CONFIG_T41ZL)
/* T41L & T41LQ & T41ZL */
#if defined(CONFIG_LP)
#define APLL_1008M
#define DDR_550M
...
#define CONFIG_SYS_VPLL_MNOD        ((0x59 << 20) | (0 << 14) | (1 << 11) | (1 << 7) | (3 << 4))
...
#if defined(CONFIG_T41N) || defined(CONFIG_T41NQ) || defined(CONFIG_T41ZN) || defined(CONFIG_T41ZMC)
/* T41N */
...
#define CONFIG_DDR_DW32                        0       /* 1-32bit-width, 0-16bit-width */
#define CONFIG_LPDDR2_M54D2G16128ACR11
#elif defined (CONFIG_T41ZX) || defined(CONFIG_T41ZGC)
/* T41ZX */
#define CONFIG_DDR_TYPE_DDR3
#define CONFIG_DDR_DW32                        0       /* 1-32bit-width, 0-16bit-width */
 ...
 */
#if defined(CONFIG_T41N) || defined(CONFIG_T41NQ) || defined(CONFIG_T41ZM) || defined(CONFIG_T41ZN)
...
#elif defined(CONFIG_T41A) || defined(CONFIG_T41ZX) || defined(CONFIG_T41XQ) || defined(CONFIG_T41ZG)
...
#define CONFIG_SPL_PAD_TO       102400 /* equal to spl max size in T41 */
#elif  defined (CONFIG_SPL_SFC_NAND)
#define CONFIG_SPL_MAX_SIZE     27648
#define CONFIG_SPL_PAD_TO		27648 /* equal to spl max size in T41 */
#elif  defined (CONFIG_SPL_MMC_SUPPORT)
#define CONFIG_SPL_MAX_SIZE     27648
#define CONFIG_SPL_PAD_TO		27648 /* equal to spl max size in T41 */
#else
#define CONFIG_SPL_MAX_SIZE		26624	/* 26624=26KB*/
#define CONFIG_SPL_PAD_TO		26624	/* equal to spl max size in T41 */
#endif
