...
static void get_refcnt_value(struct ddr_params *p, unsigned int *rfc, unsigned int *con, unsigned int *clk_div)
{
	...
	*clk_div = div;
	...
	if(tmp < 0)
		tmp = 0;
	ASSERT_MASK(tmp, 8);    //Edwin.Wen@2023.04.19 modified for A1A 8Gb KGD. tRFC need 350ns.
	*rfc = tmp;
}
...
static void a1all_head_file_create()
{
	...
	fprintf(fp, "#ifndef DDR_REG_VALUES_A1ALL_H__\n");
	fprintf(fp, "#define DDR_REG_VALUES_A1ALL_H__\n\n");
	fprintf(fp, "typedef unsigned int u32;\n");
	fprintf(fp, "typedef unsigned char u8;\n");
	fprintf(fp, "struct a1_ddr_params {\n");
	/* DDRC registers print */
	fprintf(fp, "u32 DDRC_CFG_VALUE;\n");
	fprintf(fp, "u32 DDRC_CTRL_VALUE;\n");
	fprintf(fp, "u32 DDRC_DLMR_VALUE;\n");
	fprintf(fp, "u32 DDRC_DDLP_VALUE;\n");
	fprintf(fp, "u32 DDRC_MMAP0_VALUE;\n");
	fprintf(fp, "u32 DDRC_MMAP1_VALUE;\n");
	fprintf(fp, "u32 DDRC_REFCNT_VALUE;\n");
	fprintf(fp, "u32 DDRC_TIMING1_VALUE;\n");
	fprintf(fp, "u32 DDRC_TIMING2_VALUE;\n");
	fprintf(fp, "u32 DDRC_TIMING3_VALUE;\n");
	fprintf(fp, "u32 DDRC_TIMING4_VALUE;\n");
	fprintf(fp, "u32 DDRC_TIMING5_VALUE;\n");
	fprintf(fp, "u32 DDRC_AUTOSR_CNT_VALUE;\n");
	fprintf(fp, "u32 DDRC_AUTOSR_EN_VALUE;\n");
	fprintf(fp, "u32 DDRC_HREGPRO_VALUE;\n");
	fprintf(fp, "u32 DDRC_PREGPRO_VALUE;\n");
	fprintf(fp, "u32 DDRC_CGUC0_VALUE;\n");
	fprintf(fp, "u32 DDRC_CGUC1_VALUE;\n");
#ifndef CONFIG_DDR_INNOPHY
	/* DDRP registers print */
	fprintf(fp, "u32 DDRP_DCR_VALUE;\n");
	fprintf(fp, "u32 DDRP_MR0_VALUE;\n");
	fprintf(fp, "u32 DDRP_MR1_VALUE;\n");
	fprintf(fp, "u32 DDRP_MR2_VALUE;\n");
	fprintf(fp, "u32 DDRP_MR3_VALUE;\n");
	fprintf(fp, "u32 DDRP_PTR0_VALUE;\n");
	fprintf(fp, "u32 DDRP_PTR1_VALUE;\n");
	fprintf(fp, "u32 DDRP_PTR2_VALUE;\n");
	fprintf(fp, "u32 DDRP_DTPR0_VALUE;\n");
	fprintf(fp, "u32 DDRP_DTPR1_VALUE1;\n");
	fprintf(fp, "u32 DDRP_DTPR2_VALUE2;\n");
	fprintf(fp, "u32 DDRP_PGCR_VALUE;\n");
	fprintf(fp, "u32 DDRP_ODTCR_VALUE;\n");
	for(i = 0;i < 4;i++){
		fprintf(fp, "u32 DDRP_DX%dGCR_VALUE;"\n);
	}
	fprintf(fp, "u32 DDRP_ZQNCR1_VALUE;\n");
	fprintf(fp, "u32 DDRP_IMPANDCE_ARRAY[2];\n");
	fprintf(fp, "u32 DDRP_ODT_IMPANDCE_ARRAY[2];\n");
	fprintf(fp, "u32 DDRP_RZQ_TABLE,\n");
	for(i = 1;i < sizeof(ddrp->rzq_table);i++){
		fprintf(fp, "u32 ddrp->rzq_table[%d];\n", i);
	}
#else
	fprintf(fp, "u32 DDRP_MEMCFG_VALUE;\n");
	fprintf(fp, "u32 DDRP_CL_VALUE;\n");
	fprintf(fp, "u32 DDRP_CWL_VALUE;\n");
#endif
	fprintf(fp, "u32 DDR_MR0_VALUE;\n");
	fprintf(fp, "u32 DDR_MR1_VALUE;\n");
	fprintf(fp, "u32 DDR_MR2_VALUE;\n");
	fprintf(fp, "u32 DDR_MR3_VALUE;\n");
	fprintf(fp, "u32 DDR_MR10_VALUE;\n");
	fprintf(fp, "u32 DDR_MR63_VALUE;\n");

	fprintf(fp, "u32 DDR_CHIP_0_SIZE;\n");
	fprintf(fp, "u32 DDR_CHIP_1_SIZE;\n");

	fprintf(fp, "u32 timing1_tWL;\n");
	fprintf(fp, "u32 timing1_tWR;\n");
	fprintf(fp, "u32 timing1_tWTR;\n");
	fprintf(fp, "u32 timing1_tWDLAT;\n");

	fprintf(fp, "u32 timing2_tRL;\n");
	fprintf(fp, "u32 timing2_tRTP;\n");
	fprintf(fp, "u32 timing2_tRTW;\n");
	fprintf(fp, "u32 timing2_tRDLAT;\n");

	fprintf(fp, "u32 timing3_tRP;\n");
	fprintf(fp, "u32 timing3_tCCD;\n");
	fprintf(fp, "u32 timing3_tRCD;\n");
	fprintf(fp, "u32 timing3_ttEXTRW;\n");

	fprintf(fp, "u32 timing4_tRRD;\n");
	fprintf(fp, "u32 timing4_tRAS;\n");
	fprintf(fp, "u32 timing4_tRC;\n");
	fprintf(fp, "u32 timing4_tFAW;\n");

	fprintf(fp, "u32 timing5_tCKE;\n");
	fprintf(fp, "u32 timing5_tXP;\n");
	fprintf(fp, "u32 timing5_tCKSRE;\n");
	fprintf(fp, "u32 timing5_tCKESR;\n");
	fprintf(fp, "u32 timing5_tXSr;\n");

	/*PLL & DDR config*/
	fprintf(fp, "u32 config_sys_apll_freq;\n");
	fprintf(fp, "u32 config_sys_apll_mnod;\n");
	fprintf(fp, "u32 config_sys_mpll_freq;\n");
	fprintf(fp, "u32 config_sys_mpll_mnod;\n");
	fprintf(fp, "u32 config_sys_epll_mnod;\n");
	fprintf(fp, "u32 config_sys_mem_freq;\n");
	fprintf(fp, "u8 div_pclk;\n");
	fprintf(fp, "u8 div_h2;\n");
	fprintf(fp, "u8 div_h1;\n");
	fprintf(fp, "u8 div_h0;\n");
	fprintf(fp, "u8 config_ddr_type_ddr3;\n");
	fprintf(fp, "u8 config_ddr_buswidth32;\n");
	fprintf(fp, "u8 config_ddr_dw32;\n");
	fprintf(fp, "u8 config_ddr_chip_out_val_rtt_nom_9;\n");
	fprintf(fp, "u8 config_ddr_chip_out_val_rtt_nom_6;\n");
	fprintf(fp, "u8 config_ddr_chip_out_val_rtt_nom_2;\n");
	fprintf(fp, "u8 config_ddr_driver_out_strength_1;\n");
	fprintf(fp, "u8 config_ddr_driver_out_strength_0;\n");
	fprintf(fp, "u8 config_bootargs[256];\n");
	fprintf(fp, "u32 config_sys_cpccr_sel;\n");
	fprintf(fp, "u32 config_sys_ahb1cpccr_sel;\n");

	fprintf(fp, "\n");
	fprintf(fp, "unsigned int *array;\n");
	fprintf(fp, "unsigned int (*get_refcnt_value)(int);\n");
	fprintf(fp, "\n");
	fprintf(fp, "};\n");
	fprintf(fp, "\n");
	fprintf(fp, "extern struct a1_ddr_params a1n_ddr_para;\n");
	fprintf(fp, "extern struct a1_ddr_params a1nt_ddr_para;\n");
	fprintf(fp, "extern struct a1_ddr_params a1x_ddr_para;\n");
	fprintf(fp, "extern struct a1_ddr_params a1l_ddr_para;\n");
	fprintf(fp, "\n#endif /* DDR_REG_VALUES_A1ALL_H__ */\n");
	fclose(fp);
}
...
static void inc_file_create(char * postfix)
{
	...
	fp = fopen(fname, "w");
	fprintf(fp, "#ifndef DDR_REG_VALUES_%s_H__\n", postfix);
	fprintf(fp, "#define DDR_REG_VALUES_%s_H__\n\n", postfix);
	fprintf(fp, "typedef unsigned int u32;\n");
	fprintf(fp, "typedef unsigned char u8;\n");
	fprintf(fp, "struct a1_ddr_params {\n");
	/* DDRC registers print */
	...
	fprintf(fp, "};\n");
	fprintf(fp, "\n");
	fprintf(fp, "extern struct a1_ddr_params %s_ddr_para;\n", postfix);
	fprintf(fp, "\n#endif /* DDR_REG_VALUES_%s_H__ */\n", postfix);
	fclose(fp);
}

static void src_file_mem_remap(char *postfix, struct ddr_params *p, FILE * fp)
{
	int address_bits;
	int swap_bits;
	int bank_bits;
	...
	fprintf(fp, "static unsigned int  %s_REMMAP_ARRAY[%d] = {\\\n", postfix, (sizeof(remap_array) / sizeof(remap_array[0])));
	for(i = 0;i <sizeof(remap_array) / sizeof(remap_array[0]);i++)
	{
		fprintf(fp, "\t0x%08x,\\\n",remap_array[i]);
	}
...
static void src_file_get_dynamic_refcnt(char *postfix, struct ddr_params *p, FILE * fp)
{
	unsigned int div = 0;
	unsigned int rate = CONFIG_SYS_MEM_FREQ;
	unsigned int rfc, con, clk_div;

	fprintf(fp, "static unsigned int %s_get_refcnt_value(int div)\n", postfix);
	fprintf(fp, "{\n");
	fprintf(fp, "\tswitch(div) { \n");
	do {
		rate = CONFIG_SYS_MEM_FREQ / (div + 1);
		__ps_per_tck = (1000000000 / (rate / 1000));
		...
		drefcnt.refcnt.rfc = rfc;
		/* printf("#define DDRC_REFCNT_VALUE_%d		0x%08x\n", div, drefcnt.d32);*/
		fprintf(fp, "\t\tcase %d: return 0x%x; \n", div, drefcnt.d32);
		div++;
	} while(rate > 100000000);
	fprintf(fp, "\t\tdefalut :\n");
	fprintf(fp, "\t\tprintf(\"not support \\n\");\n");
	fprintf(fp, "\t}\n");
	fprintf(fp, "}\n");
	fprintf(fp, "\n");
}
...
static void src_file_create(char *postfix, struct ddr_params *p, struct ddrc_reg *ddrc, struct ddrp_reg *ddrp)
{
	...
	fp = fopen(fname, "w");
	fprintf(fp, "#ifndef DDR_REG_VALUES_%s_C__\n", postfix);
	fprintf(fp, "#define DDR_REG_VALUES_%s_C__\n", postfix);
	fprintf(fp, "#include <generated/ddr_reg_values_a1all.h>\n");
	src_file_mem_remap(postfix, p, fp);
	src_file_get_dynamic_refcnt(postfix, p, fp);

	fprintf(fp, "struct a1_ddr_params %s_ddr_para =  {\n", postfix);
	fprintf(fp, ".DDRC_CFG_VALUE =0x%08x,\n", ddrc->cfg.d32);
	fprintf(fp, ".DDRC_CTRL_VALUE =0x%08x,\n", ddrc->ctrl);
	fprintf(fp, ".DDRC_DLMR_VALUE =0x%08x,\n", ddrc->dlmr);
	fprintf(fp, ".DDRC_DDLP_VALUE =0x%08x,\n", ddrc->ddlp);
	fprintf(fp, ".DDRC_MMAP0_VALUE =0x%08x,\n", ddrc->mmap[0]);
	fprintf(fp, ".DDRC_MMAP1_VALUE =0x%08x,\n", ddrc->mmap[1]);
	fprintf(fp, ".DDRC_REFCNT_VALUE =0x%08x,\n", ddrc->refcnt);
	fprintf(fp, ".DDRC_TIMING1_VALUE =0x%08x,\n", ddrc->timing1.d32);
	fprintf(fp, ".DDRC_TIMING2_VALUE =0x%08x,\n", ddrc->timing2.d32);
	fprintf(fp, ".DDRC_TIMING3_VALUE =0x%08x,\n", ddrc->timing3.d32);
	fprintf(fp, ".DDRC_TIMING4_VALUE =0x%08x,\n", ddrc->timing4.d32);
	fprintf(fp, ".DDRC_TIMING5_VALUE =0x%08x,\n", ddrc->timing5.d32);
	fprintf(fp, ".DDRC_AUTOSR_CNT_VALUE =0x%08x,\n", ddrc->autosr_cnt);
	fprintf(fp, ".DDRC_AUTOSR_EN_VALUE =0x%08x,\n", ddrc->autosr_en);
	fprintf(fp, ".DDRC_HREGPRO_VALUE =0x%08x,\n", ddrc->hregpro);
	fprintf(fp, ".DDRC_PREGPRO_VALUE =0x%08x,\n", ddrc->pregpro);
	fprintf(fp, ".DDRC_CGUC0_VALUE =0x%08x,\n", ddrc->cguc0);
	fprintf(fp, ".DDRC_CGUC1_VALUE =0x%08x,\n", ddrc->cguc1);
#ifndef CONFIG_DDR_INNOPHY
	/* DDRP registers print */
	fprintf(fp,".DDRP_DCR_VALUE = 0x%08x,\n",  ddrp->dcr);
	fprintf(fp,".DDRP_MR0_VALUE =0x%08x,\n",  ddrp->mr0.d32);
	fprintf(fp,".DDRP_MR1_VALUE =0x%08x,\n",  ddrp->mr1.d32);
	fprintf(fp,".DDRP_MR2_VALUE =0x%08x,\n",  ddrp->mr2.d32);
	fprintf(fp,".DDRP_MR3_VALUE =0x%08x,\n",  ddrp->mr3.d32);
	fprintf(fp,".DDRP_PTR0_VALUE =0x%08x,\n",  ddrp->ptr0.d32);
	fprintf(fp,".DDRP_PTR1_VALUE =0x%08x,\n",  ddrp->ptr1.d32);
	fprintf(fp,".DDRP_PTR2_VALUE =0x%08x,\n",  ddrp->ptr2.d32);
	fprintf(fp,".DDRP_DTPR0_VALUE =0x%08x,\n",  ddrp->dtpr0.d32);
	fprintf(fp,".DDRP_DTPR1_VALUE1 =0x%08x,\n",  ddrp->dtpr1.d32);
	fprintf(fp,".DDRP_DTPR2_VALUE2 =0x%08x,\n",  ddrp->dtpr2.d32);
	fprintf(fp,".DDRP_PGCR_VALUE =0x%08x,\n",  ddrp->pgcr);
	fprintf(fp,".DDRP_ODTCR_VALUE =0x%08x,\n",  ddrp->odtcr.d32);
	for(i = 0;i < 4;i++){
		fprintf(fp,".u32 DDRP_DX%dGCR_VALUE =0x%08x,\n", i, ddr_config = ddrp->dxngcrt[i].d32);
	}
	fprintf(fp, ".DDRP_ZQNCR1_VALUE =0x%08x,\n,ddrp->zqncr1);
	fprintf(fp, ".DDRP_IMPANDCE_ARRAY[0] =0x%08x,\n,ddrp->impedance[0]);
	fprintf(fp, ".DDRP_IMPANDCE_ARRAY[1] =0x%08x,\n,ddrp->impedance[1]);
	fprintf(fp, ".DDRP_ODT_IMPANDCE_ARRAY[0] =0x%08x,\n,ddrp->odt_impedance[0]);
	fprintf(fp, ".DDRP_ODT_IMPANDCE_ARRAY[1] =0x%08x,\n,ddrp->odt_impedance[1]);
	fprintf(fp, ".DDRP_RZQ_TABLE =0x%08x,\n,ddrp->rzq_table[0]);
	for(i = 1;i < sizeof(ddrp->rzq_table);i++){
		fprintf(fp,".ddrp->rzq_table[%d] = 0x%08x,\n",i, ddrp->rzq_table[i]);
	}
#else
	fprintf(fp,".DDRP_MEMCFG_VALUE =0x%08x,\n", ddrp->memcfg.d32);
	fprintf(fp,".DDRP_CL_VALUE =0x%08x,\n", ddrp->cl);
	fprintf(fp,".DDRP_CWL_VALUE =0x%08x,\n", ddrp->cwl);
#endif

#ifdef CONFIG_DDR_INNOPHY
	fprintf(fp,".DDR_MR0_VALUE =0x%08x,\n", p->mr0.d32);
	fprintf(fp,".DDR_MR1_VALUE =0x%08x,\n", p->mr1.d32);
	fprintf(fp,".DDR_MR2_VALUE =0x%08x,\n", p->mr2.d32);
	fprintf(fp,".DDR_MR3_VALUE =0x%08x,\n", p->mr3.d32);
	fprintf(fp,".DDR_MR10_VALUE =0x%08x,\n", p->mr10.d32);
	fprintf(fp,".DDR_MR63_VALUE =0x%08x,\n", p->mr63.d32);
#endif
	fprintf(fp,".DDR_CHIP_0_SIZE =0x%08x,\n", p->size.chip0);
	fprintf(fp,".DDR_CHIP_1_SIZE =0x%08x,\n", p->size.chip1);

	fprintf(fp,".timing1_tWL =0x%08x,\n", ddrc->timing1.b.tWL);
	fprintf(fp,".timing1_tWR =0x%08x,\n", ddrc->timing1.b.tWR);
	fprintf(fp,".timing1_tWTR =0x%08x,\n", ddrc->timing1.b.tWTR);
	fprintf(fp,".timing1_tWDLAT =0x%08x,\n", ddrc->timing1.b.tWDLAT);

	fprintf(fp,".timing2_tRL =0x%08x,\n", ddrc->timing2.b.tRL);
	fprintf(fp,".timing2_tRTP =0x%08x,\n", ddrc->timing2.b.tRTP);
	fprintf(fp,".timing2_tRTW =0x%08x,\n", ddrc->timing2.b.tRTW);
	fprintf(fp,".timing2_tRDLAT =0x%08x,\n", ddrc->timing2.b.tRDLAT);

	fprintf(fp,".timing3_tRP =0x%08x,\n", ddrc->timing3.b.tRP);
	fprintf(fp,".timing3_tCCD =0x%08x,\n", ddrc->timing3.b.tCCD);
	fprintf(fp,".timing3_tRCD =0x%08x,\n", ddrc->timing3.b.tRCD);
	fprintf(fp,".timing3_ttEXTRW =0x%08x,\n", ddrc->timing3.b.tEXTRW);

	fprintf(fp,".timing4_tRRD =0x%08x,\n", ddrc->timing4.b.tRRD);
	fprintf(fp,".timing4_tRAS =0x%08x,\n", ddrc->timing4.b.tRAS);
	fprintf(fp,".timing4_tRC =0x%08x,\n", ddrc->timing4.b.tRC);
	fprintf(fp,".timing4_tFAW =0x%08x,\n", ddrc->timing4.b.tFAW);

	fprintf(fp,".timing5_tCKE =0x%08x,\n", ddrc->timing5.b.tCKE);
	fprintf(fp,".timing5_tXP =0x%08x,\n", ddrc->timing5.b.tXP);
	fprintf(fp,".timing5_tCKSRE =0x%08x,\n", ddrc->timing5.b.tCKSRE);
	fprintf(fp,".timing5_tCKESR =0x%08x,\n", ddrc->timing5.b.tCKESR);
	fprintf(fp,".timing5_tXSr =0x%08x,\n", ddrc->timing5.b.tXS);

	fprintf(fp, ".config_sys_apll_freq =0x%08x,\n", CONFIG_SYS_APLL_FREQ);
	fprintf(fp, ".config_sys_apll_mnod =0x%08x,\n", CONFIG_SYS_APLL_MNOD);
	fprintf(fp, ".config_sys_mpll_freq =0x%08x,\n", CONFIG_SYS_MPLL_FREQ);
	fprintf(fp, ".config_sys_mpll_mnod =0x%08x,\n", CONFIG_SYS_MPLL_MNOD);
	fprintf(fp, ".config_sys_epll_mnod =0x%08x,\n", CONFIG_SYS_EPLL_MNOD);
	fprintf(fp, ".config_sys_mem_freq =0x%08x,\n", CONFIG_SYS_MEM_FREQ);
	fprintf(fp, ".div_pclk =0x%08x,\n", DIV_PCLK);
	fprintf(fp, ".div_h2 =0x%08x,\n", DIV_H2);
	fprintf(fp, ".div_h1 =0x%08x,\n", DIV_H1);
	fprintf(fp, ".div_h0 =0x%08x,\n", DIV_H0);
	fprintf(fp,	".config_ddr_type_ddr3 =0x%08x,\n", CONFIG_DDR_TYPE_DDR3);
	fprintf(fp, ".config_ddr_buswidth32 =0x%08x,\n", CONFIG_DDR_BUSWIDTH_32);
	fprintf(fp, ".config_ddr_dw32 =0x%08x,\n", CONFIG_DDR_DW32);
	fprintf(fp, ".config_ddr_chip_out_val_rtt_nom_9 =0x%08x,\n", CONFIG_DDR_CHIP_ODT_VAL_RTT_NOM_9);
	fprintf(fp, ".config_ddr_chip_out_val_rtt_nom_6 =0x%08x,\n", CONFIG_DDR_CHIP_ODT_VAL_RTT_NOM_6);
	...
	fprintf(fp, ".get_refcnt_value = %s_get_refcnt_value\n", postfix);
	fprintf(fp, "};\n");

	fprintf(fp, "\n#endif /* DDR_REG_VALUES_%s_C__*/\n", postfix);
	fclose(fp);
}
...
int main(int argc, char *argv[])
{
	...
	if (1 == argc)
		...
		/* generate include file and packet parameters to c file  with struct */
		macro_type = 0;
		type = argv[1];
	} else {
	...
	if (1 == macro_type) {
		...
		inc_file_create(type);
		src_file_create(type, &ddr_params, &ddrc, &ddrp);
	}
