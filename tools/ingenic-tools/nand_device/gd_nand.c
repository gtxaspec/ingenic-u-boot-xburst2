...
static struct device_struct device[GD_NAND_DEVICD_COUNT] = {
	...
	DEVICE_STRUCT(0x92, 2048, 2, 4, 2, 1, gdxe_errstat),
	DEVICE_STRUCT(0x01, 2048, 2, 4, 2, 1, gdxe_errstat), //esmt nand F50L1G41LB
	DEVICE_STRUCT(0x21, 2048, 2, 4, 2, 1, gdxe_errstat), //issi nand IS37SML01G
	DEVICE_STRUCT(0x91, 2048, 2, 4, 2, 1, gdxe_errstat),
	DEVICE_STRUCT(0x95, 2048, 2, 4, 2, 1, gdxe_errstat),
};
